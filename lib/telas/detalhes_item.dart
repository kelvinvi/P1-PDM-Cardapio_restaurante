...
class StateTelaDetalhesItem extends State<TelaDetalhesItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final produto = dados['produto'];
    final List<Map<String, dynamic>> carrinho = dados['carrinho'];
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(produto['imagem'], width: double.infinity, height: 200, fit: BoxFit.cover),
            SizedBox(height: 20),
            ...
            SizedBox(height: 10),
            Text('R\$ ${produto['preco'].toStringAsFixed(2)}', style: TextStyle(fontSize: 20, color: Colors.green)),
            SizedBox(height: 20),
            Row(
